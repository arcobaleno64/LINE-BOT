...
### Issue #5: 缺乏強型別設定 (🟡 中可維護性風險)

**位置**：[Program.cs](Program.cs) 所有設定讀取
...
graph TB
    ...
    FailoverService -->|主供應商| Gemini["Gemini"]
